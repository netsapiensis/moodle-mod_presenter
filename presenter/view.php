...
switch ($presenter->slide_streching) {
	case 'uniform':
        $style .= "max-width: {$slideWidth}px; height: {$slideHeight}px";
		break;
	case 'fill':
...
if ($presenter->window == 1) {
	...
	echo '<div style="width: ' . $presentationWidth . 'px; margin: 0 auto; border: 1px solid #CCC;">';
}
